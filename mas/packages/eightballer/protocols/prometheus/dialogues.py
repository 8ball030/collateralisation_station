...
class PrometheusDialogue(Dialogue):
    ...
    INITIAL_PERFORMATIVES: FrozenSet[Message.Performative] = frozenset({PrometheusMessage.Performative.ADD_METRIC, PrometheusMessage.Performative.UPDATE_METRIC})
...
class PrometheusDialogues(Dialogues, ABC):
    ...
    {PrometheusDialogue.EndState.SUCCESSFUL}    )
